...
use nautilus_model::{
    data::{
        Data, IndexPriceUpdate, InstrumentStatus, Liquidation, MarkPriceUpdate, OpenInterest,
        bar::Bar, close::InstrumentClose, delta::OrderBookDelta, depth::OrderBookDepth10,
